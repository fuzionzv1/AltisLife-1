...
compileFinal "
	...
	[life_atmbank,life_cash,owner player,player,profileNameSteam,life_coplevel,life_adminlevel,life_donator,life_medicLevel,getPlayerUID player,playerSide] remoteExecCall [""life_fnc_admininfo"",_ret];
";
